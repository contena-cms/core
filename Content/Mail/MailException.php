...
class MailException extends HttpException
{
     ...
     */
    public static function givenSendMailOptionIsInvalid(string $option, array $validOptions): ContenaHttpException
    {
        return new self(
    ...
    public static function givenMailAgentIsInvalid(string $agent): ContenaHttpException
    {
        return new self(
            Response::HTTP_INTERNAL_SERVER_ERROR,
    ...
    public static function mailBodyTooLong(int $maxContentLength): ContenaHttpException
    {
        return new self(
