...
use Contena\Core\Content\Category\Channel\AbstractNavigationRoute;
use Contena\Core\Content\Category\Event\NavigationLoadedEvent;
...
class NavigationLoader implements NavigationLoaderInterface
{
     ...
     */
    public function load(string $activeId, ChannelContext $context, string $rootId, int $depth = NavigationLoaderInterface::DEFAULT_DEPTH): Tree
    {
        $request = new Request();
