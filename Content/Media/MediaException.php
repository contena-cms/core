...
class MediaException extends HttpException
{
    ...
    public const string MEDIA_EMPTY_PATH = 'CONTENT__MEDIA_EMPTY_PATH';
    public const string MEDIA_INVALID_THUMBNAIL_ID = 'CONTENT__MEDIA_INVALID_THUMBNAIL_ID';
    public const string MEDIA_INVALID_THUMBNAIL_DATA = 'CONTENT__MEDIA_INVALID_THUMBNAIL_DATA';
    public const string MEDIA_INVALID_DIMENSION = 'CONTENT__MEDIA_INVALID_DIMENSION';
    public const string MEDIA_EXTERNAL_MEDIA_REQUIRED = 'CONTENT__MEDIA_EXTERNAL_MEDIA_REQUIRED';
    ...
    public const string MEDIA_PRESIGNED_UPLOAD_FINALIZE_FAILED = 'CONTENT__MEDIA_PRESIGNED_UPLOAD_FINALIZE_FAILED';
