...
namespace Contena\Core\Content\Media\Util;

use Contena\Core\Content\Media\MediaException;

class PathHelper
{
    private const string REGEX_CONTROL_AND_INVISIBLE_FORMAT_CHARACTERS = '/[\x00-\x1F\x7F\p{Cf}]/u';

    private const string REGEX_NON_ASCII_AND_CONTROL_BYTE_RANGES = '/[\x00-\x1F\x7F-\xFF]/';
