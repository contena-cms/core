...
class SvgContentValidator extends AbstractFileContentValidator implements ResetInterface
{
    ...
    private const string ACTIVE_CONTENT_MESSAGE = 'SVG files with active content are not allowed.';
    private const string INVALID_SVG_MESSAGE = 'The file is not a valid SVG document.';
    private const string PARSE_ERROR_MESSAGE = 'The SVG file could not be parsed.';
    ...
    private const string CC_NAMESPACE = 'http://creativecommons.org/ns#';
    private const string DC_NAMESPACE = 'http://purl.org/dc/elements/1.1/';
    private const string SODIPODI_NAMESPACE = 'http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd';
    private const string INKSCAPE_NAMESPACE = 'http://www.inkscape.org/namespaces/inkscape';
    private const string BOXY_SVG_NAMESPACE = 'https://boxy-svg.com';
    private const string SKETCH_NAMESPACE = 'http://www.bohemiancoding.com/sketch/ns';
    private const string XPACKET_PROCESSING_INSTRUCTION = 'xpacket';
    private const string DISALLOWED_NODE_TYPE = 'Node types not allowed';
    private const string DISALLOWED_ELEMENT = 'Elements not allowed';
    private const string DISALLOWED_EVENT_HANDLER_ATTRIBUTE = 'Event handler attributes not allowed';
    private const string DISALLOWED_ATTRIBUTE = 'Attributes not allowed';
    private const string DISALLOWED_ANIMATED_ATTRIBUTE = 'Animated attributes not allowed';
    private const string DISALLOWED_EXTERNAL_REFERENCE = 'External references not allowed';
    private const string DISALLOWED_EXTERNAL_STYLE_REFERENCE = 'External style references not allowed';
    private const string ANIMATE = 'animate';
    private const string ANIMATE_TRANSFORM = 'animatetransform';

    /**
     * @var list<string>
     */
    private const array ALLOWED_ANIMATED_ATTRIBUTES = [
        'cx',
        'cy',
        'fill',
        'fill-opacity',
     ...
     */
    private const array ALLOWED_SVG_DOCTYPES = [
    ...
    private function isDisallowedNodeType(\XMLReader $reader, bool $hasAllowedSvgDoctype, bool $allowXpacketProcessingInstruction = false): bool
    {
        ...
        if ($allowXpacketProcessingInstruction && $reader->nodeType === \XMLReader::PI) {
             ...
             *
             * @see \Contena\Tests\Unit\Core\Content\Media\File\SvgContentValidatorTest::testSvgWithXmpMetadataPassesValidation()
             */
