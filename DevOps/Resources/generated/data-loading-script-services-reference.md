...
## [services.repository (`Contena\Core\Framework\DataAbstractionLayer\Facade\RepositoryFacade`)](https://github.com/contena/contena/blob/trunk/src/Core/Framework/DataAbstractionLayer/Facade/RepositoryFacade.php) {#repositoryfacade}
...
* **Returns** [`Contena\Core\Framework\DataAbstractionLayer\Search\AggregationResult\AggregationResultCollection`](https://github.com/contena/contena/blob/trunk/src/Core/Framework/DataAbstractionLayer/Search/AggregationResult/AggregationResultCollection.php)
...
* **Examples:**
    * Aggregate data for multiple entities, e.g. the sum of the gross price of all products.
        ...
        ```twig
        {% set page = hook.page %}
		{# @var page \Contena\Storefront\Page\Page #}
...
* **Returns** [`Contena\Core\Framework\DataAbstractionLayer\Search\IdSearchResult`](https://github.com/contena/contena/blob/trunk/src/Core/Framework/DataAbstractionLayer/Search/IdSearchResult.php)
...
* **Returns** [`Contena\Core\Framework\DataAbstractionLayer\Search\EntitySearchResult`](https://github.com/contena/contena/blob/trunk/src/Core/Framework/DataAbstractionLayer/Search/EntitySearchResult.php)
...
* **Examples:**
    ...
    * Add associations that should be included in the result.
        ...
        ```
_________
## [services.store (`Contena\Core\Framework\DataAbstractionLayer\Facade\SalesChannelRepositoryFacade`)](https://github.com/contena/contena/blob/trunk/src/Core/Framework/DataAbstractionLayer/Facade/SalesChannelRepositoryFacade.php) {#saleschannelrepositoryfacade}
