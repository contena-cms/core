...
## [services.request (`Contena\Core\Framework\Routing\Facade\RequestFacade`)](https://github.com/contena/contena/blob/trunk/src/Core/Framework/Routing/Facade/RequestFacade.php) {#requestfacade}
...
* **Returns** `string`
    ...
    request uri
_________
## [services.acl (`Contena\Core\Framework\Script\Api\AclFacade`)](https://github.com/contena/contena/blob/trunk/src/Core/Framework/Script/Api/AclFacade.php) {#aclfacade}
...
* **Examples:**
    * Check for the `product:read` permission and query a product if the permission is granted.
        ...
        ```
_________
## [`Contena\Core\Framework\Script\Facade\ArrayFacade`](https://github.com/contena/contena/blob/trunk/src/Core/Framework/Script/Facade/ArrayFacade.php) {#arrayfacade}
...
* **Examples:**
    * Add a new element with key `test` and value 1.
        ...
        ```
_________
## [services.config (`Contena\Core\System\SystemConfig\Facade\SystemConfigFacade`)](https://github.com/contena/contena/blob/trunk/src/Core/System/SystemConfig/Facade/SystemConfigFacade.php) {#systemconfigfacade}
