<!--- auto generated by `bin/console docs:generate-trigger-reference` in the contena project, don't edit this file manually -->
...
|`mail.sent` | Triggers when a mail is send from Contena |
...
|`revocation_request.sent` | Contena\Core\Content\RevocationRequest\Event\RevocationRequestEvent |
