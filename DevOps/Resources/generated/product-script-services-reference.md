...
## [`Contena\Core\Content\Product\Hook\Pricing\CheapestPriceFacade`](https://github.com/contena/contena/blob/trunk/src/Core/Content/Product/Hook/Pricing/CheapestPriceFacade.php) {#cheapestpricefacade}
...
* **Examples:**
    * Adds a 10% surcharge to the existing calculated price
        ...
        ```
_________
## [`Contena\Core\Content\Product\Hook\Pricing\PriceCollectionFacade`](https://github.com/contena/contena/blob/trunk/src/Core/Content/Product/Hook/Pricing/PriceCollectionFacade.php) {#pricecollectionfacade}
...
_________
## [`Contena\Core\Content\Product\Hook\Pricing\ProductProxy`](https://github.com/contena/contena/blob/trunk/src/Core/Content/Product/Hook/Pricing/ProductProxy.php) {#productproxy}
...
* The `__get()` function allows access to all properties of the [SalesChannelProductEntity](https://github.com/contena/contena/blob/trunk/src/Core/Content/Product/SalesChannel/SalesChannelProductEntity.php)
...
* **Returns** [`Contena\Core\Content\Product\Hook\Pricing\PriceCollectionFacade`](./product-script-services-reference#pricecollectionfacade) | `null`
