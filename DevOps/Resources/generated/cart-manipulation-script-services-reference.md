...
## [services.cart (`Contena\Core\Checkout\Cart\Facade\CartFacade`)](https://github.com/contena/contena/blob/trunk/src/Core/Checkout/Cart/Facade/CartFacade.php) {#cartfacade}
...
* **Returns** [`Contena\Core\Checkout\Cart\Facade\DiscountFacade`](./cart-manipulation-script-services-reference#discountfacade)
...
* **Examples:**
    * Add an absolute discount to the cart.
        ...
        ```twig
        {# @var services \Contena\Core\Framework\Script\ServiceStubs #}
...
* **Returns** [`Contena\Core\Checkout\Cart\Facade\ErrorsFacade`](./cart-manipulation-script-services-reference#errorsfacade)
...
* **Returns** [`Contena\Core\Checkout\Cart\Facade\ItemFacade`](./cart-manipulation-script-services-reference#itemfacade) | `null`
...
* **Returns** [`Contena\Core\Checkout\Cart\Facade\ItemsFacade`](./cart-manipulation-script-services-reference#itemsfacade)
...
* **Returns** [`Contena\Core\Checkout\Cart\Facade\CartPriceFacade`](./cart-manipulation-script-services-reference#cartpricefacade)
...
* **Returns** [`Contena\Core\Checkout\Cart\Facade\ProductsFacade`](./cart-manipulation-script-services-reference#productsfacade)
...
* **Returns** [`Contena\Core\Checkout\Cart\Facade\StatesFacade`](./cart-manipulation-script-services-reference#statesfacade)
...
* **Examples:**
    ...
    * Add a relative surcharge to the cart.
        ...
        ```
_________
## [`Contena\Core\Checkout\Cart\Facade\CartPriceFacade`](https://github.com/contena/contena/blob/trunk/src/Core/Checkout/Cart/Facade/CartPriceFacade.php) {#cartpricefacade}
...
* **Returns** [`Contena\Core\Framework\DataAbstractionLayer\Pricing\PriceCollection`](https://github.com/contena/contena/blob/trunk/src/Core/Framework/DataAbstractionLayer/Pricing/PriceCollection.php)
...
* **Returns** `float`
    ...
    The rounded total price of the cart as float.
_________
## [`Contena\Core\Checkout\Cart\Facade\ContainerFacade`](https://github.com/contena/contena/blob/trunk/src/Core/Checkout/Cart/Facade/ContainerFacade.php) {#containerfacade}
...
* **Returns** [`Contena\Core\Checkout\Cart\Facade\ItemFacade`](./cart-manipulation-script-services-reference#itemfacade)

    The item that was added to the container.
* **Arguments:**
    * *[`Contena\Core\Checkout\Cart\Facade\ItemFacade`](./cart-manipulation-script-services-reference#itemfacade)* **item**: The item that should be added.
* **Examples:**
...
* **Returns** [`Contena\Core\Framework\Script\Facade\ArrayFacade`](./miscellaneous-script-services-reference#arrayfacade)
...
* **Returns** [`Contena\Core\Checkout\Cart\Facade\PriceFacade`](./cart-manipulation-script-services-reference#pricefacade) | `null`
...
* **Examples:**
    * Take a quantity of 2 from an existing product line-item and add it to the cart again.
        ...
        ```
_________
## [`Contena\Core\Checkout\Cart\Facade\DiscountFacade`](https://github.com/contena/contena/blob/trunk/src/Core/Checkout/Cart/Facade/DiscountFacade.php) {#discountfacade}
...
_________
## [`Contena\Core\Checkout\Cart\Facade\ErrorsFacade`](https://github.com/contena/contena/blob/trunk/src/Core/Checkout/Cart/Facade/ErrorsFacade.php) {#errorsfacade}
...
* **Returns** [`Contena\Core\Checkout\Cart\Error\Error`](https://github.com/contena/contena/blob/trunk/src/Core/Checkout/Cart/Error/Error.php) | `null`
...
* **Examples:**
    * Add a warning to the cart.
        ...
        ```
_________
## [`Contena\Core\Checkout\Cart\Facade\ItemFacade`](https://github.com/contena/contena/blob/trunk/src/Core/Checkout/Cart/Facade/ItemFacade.php) {#itemfacade}
...
* **Examples:**
    * Take a quantity of 2 from an existing product line-item and add it to the cart again.
        ...
        ```
_________
## [`Contena\Core\Checkout\Cart\Facade\ItemsFacade`](https://github.com/contena/contena/blob/trunk/src/Core/Checkout/Cart/Facade/ItemsFacade.php) {#itemsfacade}
...
* **Arguments:**
    * *[`Contena\Core\Checkout\Cart\Facade\ItemFacade`](./cart-manipulation-script-services-reference#itemfacade)* **item**: The line-item that should be added.
* **Examples:**
    * Add an absolute discount to the cart.
...
* **Examples:**
    * Add and then remove a product line-item from the cart.
        ...
        ```
_________
## [`Contena\Core\Checkout\Cart\Facade\PriceFacade`](https://github.com/contena/contena/blob/trunk/src/Core/Checkout/Cart/Facade/PriceFacade.php) {#pricefacade}
...
* **Arguments:**
    * *[`Contena\Core\Framework\DataAbstractionLayer\Pricing\PriceCollection`](https://github.com/contena/contena/blob/trunk/src/Core/Framework/DataAbstractionLayer/Pricing/PriceCollection.php)* **price**: The provided price can be a fetched price from the database or generated over the `PriceFactory` statically
* **Examples:**
...
* **Returns** [`Contena\Core\Checkout\Cart\Tax\Struct\TaxRuleCollection`](https://github.com/contena/contena/blob/trunk/src/Core/Checkout/Cart/Tax/Struct/TaxRuleCollection.php)
...
* **Returns** [`Contena\Core\Checkout\Cart\Tax\Struct\CalculatedTaxCollection`](https://github.com/contena/contena/blob/trunk/src/Core/Checkout/Cart/Tax/Struct/CalculatedTaxCollection.php)
...
* **Examples:**
    * Adds a 10% surcharge to the existing calculated price
        ...
        ```
_________
## [services.price (`Contena\Core\Checkout\Cart\Facade\PriceFactory`)](https://github.com/contena/contena/blob/trunk/src/Core/Checkout/Cart/Facade/PriceFactory.php) {#pricefactory}
...
* **Examples:**
    * Create a new Price in the default currency.
        ...
        ```
_________
## [`Contena\Core\Checkout\Cart\Facade\ProductsFacade`](https://github.com/contena/contena/blob/trunk/src/Core/Checkout/Cart/Facade/ProductsFacade.php) {#productsfacade}
...
* **Examples:**
    * Add and then remove a product line-item from the cart.
        ...
        ```
_________
## [`Contena\Core\Checkout\Cart\Facade\StatesFacade`](https://github.com/contena/contena/blob/trunk/src/Core/Checkout/Cart/Facade/StatesFacade.php) {#statesfacade}
