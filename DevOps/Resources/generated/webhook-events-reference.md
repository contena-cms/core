...
|`mail.sent` | Triggers when a mail is send from Contena | - | {"subject":"string","contents":"string","recipients":"array"}
...
|`contena.updated` | Fires after an contena update has been finished | - |
