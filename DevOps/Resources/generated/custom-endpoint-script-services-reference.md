...
## [services.cache (`Contena\Core\Framework\Adapter\Cache\Script\Facade\CacheInvalidatorFacade`)](https://github.com/contena/contena/blob/trunk/src/Core/Framework/Adapter/Cache/Script/Facade/CacheInvalidatorFacade.php) {#cacheinvalidatorfacade}
...
* **Examples:**
    ...
    * Build tags if products with a specific property is created and invalidate those tags.
        ...
        ```
_________
## [services.writer (`Contena\Core\Framework\DataAbstractionLayer\Facade\RepositoryWriterFacade`)](https://github.com/contena/contena/blob/trunk/src/Core/Framework/DataAbstractionLayer/Facade/RepositoryWriterFacade.php) {#repositorywriterfacade}

The `writer` service allows you to write data, that is stored inside contena.
...
* **Returns** [`Contena\Core\Framework\DataAbstractionLayer\Event\EntityWrittenContainerEvent`](https://github.com/contena/contena/blob/trunk/src/Core/Framework/DataAbstractionLayer/Event/EntityWrittenContainerEvent.php)
...
* **Returns** [`Contena\Core\Framework\Api\Sync\SyncResult`](https://github.com/contena/contena/blob/trunk/src/Core/Framework/Api/Sync/SyncResult.php)
...
* **Examples:**
    ...
    * Update an existing entity.
        ...
        ```
_________
## [services.response (`Contena\Core\Framework\Script\Api\ScriptResponseFactoryFacade`)](https://github.com/contena/contena/blob/trunk/src/Core/Framework/Script/Api/ScriptResponseFactoryFacade.php) {#scriptresponsefactoryfacade}
...
* **Returns** [`Contena\Core\Framework\Script\Api\ScriptResponse`](https://github.com/contena/contena/blob/trunk/src/Core/Framework/Script/Api/ScriptResponse.php)
...
**Deprecated:** tag:v6.8.0 - Rendering Storefront templates through the core response service is deprecated. Type the response service as `Contena\Storefront\Framework\Script\Api\StorefrontScriptResponseFactoryFacade` in Storefront script hooks and use this core facade without `render()` in admin-api/store-api hooks.
