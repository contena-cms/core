...
namespace Contena\Core\DevOps\Test;
...
{
    /**
     * captures any contena version like 6.4.0.0 but also old version with 3 digits like 6.2.0
     */
    private const string PLATFORM_VERSION_SCHEMA = '(\d+\.?){2,3}\d+';

    /**
     * captures a deprecation tag version like 6.5.0
     */
    private const string PLATFORM_DEPRECATION_SCHEMA = 'v((\d+\.?){2}\d+)';

    /**
     * captures a manifest schema version like 1.0
     */
    private const string MANIFEST_VERSION_SCHEMA = '(\d+\.\d+)';
    ...
    private function validateAgainstPlatformVersion(string $version): void
    {
        ...
        $this->compareVersion($this->contenaVersion, $matches[1]);
    }
