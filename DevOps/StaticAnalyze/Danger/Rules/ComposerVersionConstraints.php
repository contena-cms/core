...
{
    private const array PACKAGE_EXCEPTIONS = [
        '~' => [
        ...
        'strict' => [
            ...
            '^contena\/conflicts$' => 'The contena conflicts packages should be required in any version, so use `*` constraint',
            '^contena\/core$' => 'The contena core packages should be required in any version, so use `*` constraint, the version constraint will be automatically synced during the release process',
