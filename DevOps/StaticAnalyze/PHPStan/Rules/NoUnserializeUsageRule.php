 ...
 *
 * In test classes the error is non-ignorable: use \Contena\Core\Test\Assert\Serialization instead.
 *
 * @internal
 *
...
class NoUnserializeUsageRule implements Rule
{
    ...
    final public const string RULE_IDENTIFIER = 'contena.unserializeUsage';
    ...
    final public const string ERROR_TIP_TESTS = 'In test classes, use \Contena\Core\Test\Assert\Serialization::assertRoundTrip(), ::assertUnserializedInstanceOf(), ::assertUnserializedIsArray(), ::assertUnserializedEquals(), or ::assertUnserializedSame() instead.';
