...
{
    public const string INVALID_KEY_ERROR_MESSAGE = 'Permission "%s" is not a valid backend ACL key. If it\'s an entity based permission, please check if entity is listed in the entity-schema.json. If it\'s a custom permissions, please check if it should be added to the allowlist.';

    public const string MISSING_SCHEMA_ERROR_MESSAGE = 'The entity-schema.json file is missing. Please make sure to generate it first via the administration command. Could not look up permission "%s" in the schema.';

    private const string SCHEMA_FILE = __DIR__ . '/../../../../../Administration/Resources/app/administration/test/_mocks_/entity-schema.json';

    private const array CUSTOM_PERMISSIONS = [
