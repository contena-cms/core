...
{
    private const string MCP_TOOL_ATTRIBUTE = 'Mcp\Capability\Attribute\McpTool';
    private const string MCP_TOOL_RESPONSE_CLASS = 'Contena\Core\Framework\Mcp\Tool\McpToolResponse';
    ...
    public function processNode(Node $node, Scope $scope): array
    {
        ...
        return [
            RuleErrorBuilder::message('MCP tools with #[McpTool] attribute must extend McpToolResponse.')
                ->identifier('contena.mcpToolMissingResponseClass')
                ->build(),
        ];
    }
