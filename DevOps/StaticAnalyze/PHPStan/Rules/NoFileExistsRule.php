...
{
    public const string FILE_EXISTS_INFORMATION = 'The method file_exists is inefficient. Additionally, it cannot distinguish between files and directories. Use is_dir or is_file instead.';
