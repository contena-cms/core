...
class UseHasherRule implements Rule
{
    ...
    private const array NOT_ALLOWED_FUNCTIONS = ['md5', 'md5_file', 'sha1', 'sha1_file', 'hash', 'hash_file'];
    private const string HASHER_CLASS = Hasher::class;
