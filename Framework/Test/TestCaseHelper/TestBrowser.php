...
class TestBrowser extends KernelBrowser
{
     ...
     *
     * Contena often wants to use that accept header with a value of `application/vnd.api+json,application/json`
     * see e.g. \Contena\Core\Framework\Test\TestCaseBase\AdminApiTestBehaviour::createClient
     *
