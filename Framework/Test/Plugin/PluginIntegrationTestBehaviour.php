...
trait PluginIntegrationTestBehaviour
{
    ...
    protected function getNotInstalledPlugin(): PluginEntity
    {
        ...
        $plugin->assign([
            ...
            'version' => '1.0.1',
            'active' => false,
            'path' => __DIR__ . '/../../../../../tests/integration/Core/Framework/Plugin/_fixtures/plugins/CtTestPlugin',
            'autoload' => ['psr-4' => ['CtTestPlugin\\' => 'src/']],
    ...
    protected function getInstalledInactivePluginRebuildDisabled(): PluginEntity
    {
        ...
        $plugin->assign([
            'id' => Uuid::randomHex(),
            'name' => 'CtTestSkipRebuild',
            'baseClass' => CtTestSkipRebuild::class,
            'version' => '1.0.1',
            'active' => false,
            'path' => __DIR__ . '/../../../../../tests/integration/Core/Framework/Plugin/_fixtures/plugins/CtTestSkipRebuild',
            'autoload' => ['psr-4' => ['CtTestSkipRebuild\\' => 'src/']],
            'createdAt' => new \DateTimeImmutable('2019-01-01'),
            'managedByComposer' => false,
        ]);
    ...
    protected function getActivePluginWithBundle(): PluginEntity
    {
        ...
        $plugin->assign([
            'id' => Uuid::randomHex(),
            'name' => 'CtTestWithBundle',
            'baseClass' => CtTestWithBundle::class,
            'version' => '1.0.0',
            'active' => false,
            'path' => __DIR__ . '/../../../../../tests/integration/Core/Framework/Plugin/_fixtures/plugins/CtTestWithBundle',
            'autoload' => ['psr-4' => ['CtTestWithBundle\\' => 'src/']],
            'createdAt' => new \DateTimeImmutable('2019-01-01'),
            'managedByComposer' => false,
        ]);
