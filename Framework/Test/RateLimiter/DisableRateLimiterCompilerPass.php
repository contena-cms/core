...
namespace Contena\Core\Framework\Test\RateLimiter;

use Contena\Core\Framework\RateLimiter\NoLimitRateLimiterFactory;
...
class DisableRateLimiterCompilerPass implements CompilerPassInterface
{
    ...
    public function process(ContainerBuilder $container): void
    {
        ...
        $rateLimiter = $container->getDefinition('contena.rate_limiter');
