    ...
    public function addMigrationSources(): void
    {
        ...
        $loader->addSource(
            new MigrationSource(
                ...
                [__DIR__ . '/_test_migrations_invalid_namespace' => 'Contena\Core\Framework\Test\Migration\_test_migrations_invalid_namespace']
            )
        );
        ...
        $loader->addSource(
            new MigrationSource(
                ...
                [__DIR__ . '/_test_migrations_valid' => 'Contena\Core\Framework\Test\Migration\_test_migrations_valid']
            )
        );
        ...
        $loader->addSource(
            new MigrationSource(
                ...
                [__DIR__ . '/_test_migrations_valid_run_time' => 'Contena\Core\Framework\Test\Migration\_test_migrations_valid_run_time']
            )
        );
        ...
        $loader->addSource(
            new MigrationSource(
                ...
                [__DIR__ . '/_test_migrations_valid_run_time_exceptions' => 'Contena\Core\Framework\Test\Migration\_test_migrations_valid_run_time_exceptions']
            )
        );
        ...
        $loader->addSource(
            new MigrationSource(
                ...
                [__DIR__ . '/_test_trigger_with_trigger_' => 'Contena\Core\Framework\Test\Migration\_test_trigger_with_trigger_']
            )
        );
