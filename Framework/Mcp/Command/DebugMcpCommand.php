...
class DebugMcpCommand extends Command
{
    ...
    public function __construct(
        ...
        private readonly Builder $channelApiBuilder,
        private readonly RegistryInterface $channelApiRegistry,
        private readonly McpCapabilityCatalog $channelApiCatalog,
    ) {
        parent::__construct();
    }
     ...
     * ordered admin before channel-api. 'name' prefixes every section heading, 'label' titles the
