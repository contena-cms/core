...
Canonical user-facing MCP documentation now lives in [`contena/docs` PR #2264](https://github.com/contena/docs/pull/2264):
...
| Doc | Purpose |
|---|---|
| [Channel API MCP server](channel-api-mcp.md) | Internal reference for the `/channel-api/_mcp` endpoint: auth, capability registration, rate limiting, sessions, limitations |
...
If a topic is already covered in `contena/docs`, do not reintroduce it here unless it is repo-internal planning or audit material.
