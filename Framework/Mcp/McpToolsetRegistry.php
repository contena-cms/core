...
{
    final public const LIST_TOOLSETS_TOOL = 'contena-toolsets-list';

    final public const ENABLE_TOOLSET_TOOL = 'contena-toolset-enable';
     ...
     * @internal
     *
     * A null provider leaves toolset generation unscoped.
     */
