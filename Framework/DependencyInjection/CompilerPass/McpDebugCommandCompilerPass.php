 ...
 *
 * Both commands are called "debug:mcp": Contena's {@see \Contena\Core\Framework\Mcp\Command\DebugMcpCommand}
 * and the one the bundle added in 0.12. Two services claiming one name means the console silently
 * resolves to whichever was registered last, and the bundle's would win. Contena's command is the
