...
class DependencyInjectionException extends HttpException
{
    ...
    public const string DATA_LOADER_DUPLICATE_SOURCE = 'FRAMEWORK__DATA_LOADER_DUPLICATE_SOURCE';
    ...
    public const string DATA_LOADER_CONFIG_KEY_UNKNOWN_REFERENCED_TYPE = 'FRAMEWORK__DATA_LOADER_CONFIG_KEY_UNKNOWN_REFERENCED_TYPE';
    public const string DATA_LOADER_CONFIG_KEY_REFERENCED_TYPE_MISPLACED = 'FRAMEWORK__DATA_LOADER_CONFIG_KEY_REFERENCED_TYPE_MISPLACED';
    public const string DATA_LOADER_CONFIG_KEY_INVALID_MERGE = 'FRAMEWORK__DATA_LOADER_CONFIG_KEY_INVALID_MERGE';
    public const string DATA_LOADER_SOURCE_WITHOUT_CONFIG_SERIALIZER = 'FRAMEWORK__DATA_LOADER_SOURCE_WITHOUT_CONFIG_SERIALIZER';
    public const string DATA_LOADER_CLASS_IS_ABSTRACT = 'FRAMEWORK__DATA_LOADER_CLASS_IS_ABSTRACT';
