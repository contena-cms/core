...
{
    public const string LABEL_REAL_MISS = 'REAL_MISS';
    public const string LABEL_CROSS_MAJOR = 'CROSS_MAJOR';
    public const string LABEL_CROSS_MAJOR_PARTIAL = 'CROSS_MAJOR_PARTIAL';

    public const array LABEL_DESCRIPTIONS = [
        self::LABEL_REAL_MISS => 'no later-major migration registers this indexer — installations upgrading past the miss never get a catch-up re-index.',
        self::LABEL_CROSS_MAJOR => 'a later-major migration registers the indexer with a full re-index — installations that traverse that major catch up, but installations pinned at the miss-major stay out-of-sync.',
