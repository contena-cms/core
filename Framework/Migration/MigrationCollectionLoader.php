...
class MigrationCollectionLoader
{
    ...
    private const int BEFORE_PREVIOUS_MAJOR_VERSION_SUBTRAHEND = 2;
    private const int FIRST_MINOR_VERSION = 1;
    ...
    public function collectAllForVersion(string $version, string $mode = self::VERSION_SELECTION_ALL): MigrationCollection
    {
        $namespaces = array_filter(
            ...
            static fn (MigrationSource $source): bool => str_starts_with($source->getName(), 'core.')
        );
        ksort($namespaces);
