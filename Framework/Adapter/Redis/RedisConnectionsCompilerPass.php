...
class RedisConnectionsCompilerPass implements CompilerPassInterface
{
    ...
    {
        if (!$container->hasParameter('contena.redis.connections')) {
            return [];
        }

        /** @var ConnectionConfiguration[] $connections */
        $connections = $container->getParameter('contena.redis.connections');
        ...
        foreach ($connections as $name => $connection) {
            ...
            $serviceId = 'contena.redis.connection.' . $name;
