...
{
    private const string KEY = 'invalidation';
    ...
    public function __construct(
        /**
         * @phpstan-ignore contena.propertyNativeType (Cannot type natively, as Symfony might change the implementation in the future)
         */
        private $redis,
