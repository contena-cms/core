 ...
 * @codeCoverageIgnore
 *
 * @see \Contena\Tests\Integration\Core\Framework\Adapter\Cache\InvalidatorStorage\MySQLInvalidatorStorageTest
 */
class MySQLInvalidatorStorage extends AbstractInvalidatorStorage
{
    private const string TABLE_NAME = 'invalidation_tags';
