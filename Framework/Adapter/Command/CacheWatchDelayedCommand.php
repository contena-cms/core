...
{
    private const int DEFAULT_POLL_INTERVAL_MICROSECONDS = 1000;
    private const int MIN_POLL_INTERVAL_MICROSECONDS = 1;
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if (!$this->container->has('contena.cache.invalidator.storage.redis_adapter')) {
        ...
        $adapter = $this->container->get('contena.cache.invalidator.storage.redis_adapter');
     ...
     * @codeCoverageIgnore
     *
     * @see \Contena\Tests\Integration\Core\Framework\Adapter\Command\CacheWatchDelayedCommandTest
     *
