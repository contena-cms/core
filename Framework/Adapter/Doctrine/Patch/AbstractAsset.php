 ...
 *
 * This patch can be removed after upgrading to DBAL 5.0: https://github.com/doctrine/dbal/pull/7031
 */
    ...
    protected function _setName(string $name): void
    {
        ...
        if ($input !== '') {
            try {
                ...
                // Mute as this will always happen with CONTENA current foreign keys, as they are not compatible
                // with this parser, since they are not strict (e.g. `fk.contena.order_address`).
                /*
                Deprecation::trigger(
                    'doctrine/dbal',
                    'https://github.com/doctrine/dbal/pull/6592',
