...
class MySQLFactory
{
    ...
    /**
     * Returns true, when bin/ci is used and Contena is called in a CI/CD environment where the Database is not available to warmup caches
     */
    ...
    public static function create(array $middlewares = []): Connection
    {
        ...
        if ($url === '') {
            $url = 'mysql://root:contena@127.0.0.1:3306/contena';
        }
