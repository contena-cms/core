...
{
    /**
     * Used by ReturnNode when a Twig macro returns an explicit value.
     */
     ...
     * Implements a shortcut for receiving property values from the Contena specific `Struct` class.
