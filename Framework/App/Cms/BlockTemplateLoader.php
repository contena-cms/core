...
namespace Contena\Core\Framework\App\Cms;

use Contena\Core\Framework\App\Exception\AppCmsExtensionException;
...
class BlockTemplateLoader extends AbstractBlockTemplateLoader
{
    public function getTemplateForBlock(CmsExtensions $cmsExtensions, string $blockName): string
    {
        ...
        // @phpstan-ignore contena.domainException (the upstream CMS loader exposes this runtime exception)
