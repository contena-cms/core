...
class ContentSystemException extends HttpException
{
    ...
    public static function layoutAssignmentNotFound(string $entityType, string $entityId, string $channelId): self
    {
        return new self(
            ...
            'No layout assignment found for {{ entityType }} "{{ entityId }}" in channel "{{ channelId }}"',
    ...
    // The assignment-mismatch write violation, shared by the Core entity-assignment validator and the Frontend
    ...
    // (Core) or the section id (Frontend); $propertyPath is the assignment's content_layout_id field path.
