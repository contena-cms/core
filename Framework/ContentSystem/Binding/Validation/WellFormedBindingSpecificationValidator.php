...
final class WellFormedBindingSpecificationValidator extends ConstraintValidator
{
    public function validate(mixed $value, Constraint $constraint): void
    {
        if (!$constraint instanceof WellFormedBindingSpecification) {
            throw new UnexpectedTypeException($constraint, WellFormedBindingSpecification::class); // @phpstan-ignore contena.domainException (Symfony ConstraintValidator convention)
        }

        if (!$value instanceof BindingSpecificationDto) {
            throw new UnexpectedTypeException($value, BindingSpecificationDto::class); // @phpstan-ignore contena.domainException (Symfony ConstraintValidator convention)
        }
