...
namespace Contena\Core\Framework\ContentSystem\Binding\Validation;
...
final class TypeConsistentBindingSpecificationValidator extends ConstraintValidator
{
    ...
    public function validate(mixed $value, Constraint $constraint): void
    {
        if (!$constraint instanceof TypeConsistentBindingSpecification) {
            throw new UnexpectedTypeException($constraint, TypeConsistentBindingSpecification::class); // @phpstan-ignore contena.domainException (Symfony ConstraintValidator convention)
        }

        if (!$value instanceof BindingSpecificationDtoCollection) {
            throw new UnexpectedTypeException($value, BindingSpecificationDtoCollection::class); // @phpstan-ignore contena.domainException (Symfony ConstraintValidator convention)
        }
