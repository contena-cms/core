...
|---------------------------------------------------|-------------------|----------------|-----------------------------------------------------------------------------------------------------|
| `/channel-api/content/blog/{blogId}`          | BlogEntity     | `blog`      | `manufacturer.media`, `options.group`, `properties.group`, `mainCategories.category`, `media.media` |
| `/channel-api/content/category/{categoryId}`        | CategoryEntity    | `category`     | `media`, `translations`                                                                             |
| `/channel-api/content/landing-page/{landingPageId}` | LandingPageEntity | `landing_page` | (none)                                                                                              |
