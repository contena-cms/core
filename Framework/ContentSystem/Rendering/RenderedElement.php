...
/**
 * One element as rendering and the Channel API see it, and the counterpart to {@see StoredElement} on the far
 ...
 *
 * Because this is not a `Struct`, `ChannelApiSeoResolver` cannot walk it through `getVars()` and instead
