...
**Example:** Plugin `AcmeStore` with file `Resources/content-system/types/blog/quick-view.yaml` produces type name `AcmeStore:Blog:QuickView`.
...
meta:
  label: "Quick View"
  description: "Inline blog preview overlay"
  icon: "regular-eye"
  category: "blog"
  copilot:
    summary: "Shows a quick blog preview"
    hints:
