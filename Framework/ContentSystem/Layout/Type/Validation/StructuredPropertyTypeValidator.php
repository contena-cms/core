...
final class StructuredPropertyTypeValidator extends ConstraintValidator
{
    public function validate(mixed $value, Constraint $constraint): void
    {
        if (!$constraint instanceof StructuredPropertyType) {
            throw new UnexpectedTypeException($constraint, StructuredPropertyType::class); // @phpstan-ignore contena.domainException (Symfony ConstraintValidator convention)
        }
