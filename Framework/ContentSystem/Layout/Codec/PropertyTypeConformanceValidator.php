...
final class PropertyTypeConformanceValidator extends ConstraintValidator
{
    ...
    public function validate(mixed $value, Constraint $constraint): void
    {
        if (!$constraint instanceof PropertyTypeConformance) {
            throw new UnexpectedTypeException($constraint, PropertyTypeConformance::class); // @phpstan-ignore contena.domainException (Symfony ConstraintValidator convention)
        }
