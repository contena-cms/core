 ...
 * ({@see \Contena\Core\Framework\ContentSystem\Rendering\ContextDistributor::distribute()}:
 ...
 * ({@see \Contena\Core\Framework\ContentSystem\Rendering\WiringPlanner}, over the pre-prune forest) and
 * the diagnostics context walk
 * ({@see \Contena\Core\Framework\ContentSystem\Resolution\AvailableContextResolver}, over the target and
