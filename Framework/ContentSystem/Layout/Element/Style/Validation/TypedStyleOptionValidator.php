...
final class TypedStyleOptionValidator extends ConstraintValidator
{
    ...
    public function validate(mixed $value, Constraint $constraint): void
    {
        if (!$constraint instanceof TypedStyleOption) {
            throw new UnexpectedTypeException($constraint, TypedStyleOption::class); // @phpstan-ignore contena.domainException (Symfony ConstraintValidator convention)
        }

        if (!$value instanceof StyleOptionSpecificationDto) {
            throw new UnexpectedTypeException($value, StyleOptionSpecificationDto::class); // @phpstan-ignore contena.domainException (Symfony ConstraintValidator convention)
        }
