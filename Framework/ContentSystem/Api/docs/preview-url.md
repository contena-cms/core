...
Entity resolution and hydration do not run at mint time; they happen when the returned URL is opened, so `unknownEntityType` and hydration faults surface on the Frontend render route, not here.
