  ...
  "layout": [
    {
      ...
      "properties": { "tag": "h1" },
      "dataRequirements": {
        "blog": { "key": "blog", "source": "entity", "config": { "entity": "blog", "property": "blogId" } }
      },
      "slots": {},
      "providesContext": {},
      "acceptsContext": {}
...
The full-format `ContentPage`, serialized through the full-format response factory, using the same structure as the Channel API full format. No caching. The preview always renders fresh.
