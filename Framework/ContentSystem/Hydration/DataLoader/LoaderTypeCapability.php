...
{
    /**
     * @param class-string<Struct> $producedType the actual runtime type (Channel class where applicable)
     * @param array<string, mixed> $configTemplate inferable config to produce this type, e.g. ['entity' => 'product']
     * @param list<class-string> $genericParameters informational only (schema display, e.g. EntityCollection<ChannelProductEntity>); not used for matching
     */
