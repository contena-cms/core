...
use Contena\Core\Framework\DataAbstractionLayer\Exception\ImpossibleWriteOrderException;
...
use Contena\Core\Framework\DataAbstractionLayer\Exception\UnableToLoadPathException;
...
class DataAbstractionLayerException extends HttpException
{
    ...
    public const string VERSION_MERGE_SAME_VERSION = 'FRAMEWORK__VERSION_MERGE_SAME_VERSION';
    ...
    public const string BLOG_SEARCH_CONFIGURATION_NOT_FOUND = 'FRAMEWORK__BLOG_SEARCH_CONFIGURATION_NOT_FOUND';
    ...
    public const string CRITERIA_FIELDS_AND_EXCLUDED_FIELDS_MUTUALLY_EXCLUSIVE = 'FRAMEWORK__DAL_CRITERIA_FIELDS_AND_EXCLUDED_FIELDS_MUTUALLY_EXCLUSIVE';
    public const string FIELD_CANNOT_BE_EXCLUDED = 'FRAMEWORK__DAL_FIELD_CANNOT_BE_EXCLUDED';
    public const string CANNOT_EXCLUDE_UNKNOWN_FIELD = 'FRAMEWORK__DAL_CANNOT_EXCLUDE_UNKNOWN_FIELD';
    ...
    public static function invalidFilterQuery(string $message, string $path = ''): self
    {
        return new InvalidFilterQueryException(
            Response::HTTP_BAD_REQUEST,
            'FRAMEWORK__INVALID_FILTER_QUERY',
            $message,
            ['path' => $path]
        );
    }
    ...
    public static function fieldHasNoType(string $fieldName): self
    {
        return new self(
            Response::HTTP_INTERNAL_SERVER_ERROR,
            'FRAMEWORK__FIELD_TYPE_NOT_FOUND',
    ...
    public static function referenceFieldByStorageNameNotFound(string $entity, string $storageName): self
    {
        return new self(
            Response::HTTP_INTERNAL_SERVER_ERROR,
            'FRAMEWORK__REFERENCE_FIELD_BY_STORAGE_NAME_NOT_FOUND',
    ...
    public static function configNotFound(): self
    {
        return new self(
            Response::HTTP_INTERNAL_SERVER_ERROR,
            self::BLOG_SEARCH_CONFIGURATION_NOT_FOUND,
            'Configuration for blog search definition not found',
        );
    }

    public static function unmappedField(string $field, EntityDefinition $definition): Exception\UnmappedFieldException
    {
    ...
    public static function invalidCompressedCriteriaParameter(string $message): self
    {
        return new self(
            Response::HTTP_BAD_REQUEST,
            'FRAMEWORK__INVALID_COMPRESSED_CRITERIA_PARAMETER',
