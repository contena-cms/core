...
class CompressedCriteriaDecoder
{
     ...
     */
    private const int DEFAULT_DECOMPRESSED_CRITERIA_LENGTH_LIMIT = self::DEFAULT_COMPRESSED_CRITERIA_LENGTH_LIMIT * 20;

    /**
     * Setting default to 128kb, which should be a reasonable limit for parameters provided via URL.
     */
    private const int DEFAULT_COMPRESSED_CRITERIA_LENGTH_LIMIT = 1024 * 128;
