...
use Contena\Core\Framework\DataAbstractionLayer\Exception\QueryLimitExceededException;
...
class RequestCriteriaBuilder
{
     ...
     */
    public const string STATE_NO_EXPLICIT_LIMIT_IN_REQUEST = 'no-explicit-limit-in-request';

    final public const array KNOWN_FIELDS = [
        'ids',
        'total-count-mode',
        'limit',
        'page',
    ...
    private const array TOTAL_COUNT_MODE_MAPPING = [
