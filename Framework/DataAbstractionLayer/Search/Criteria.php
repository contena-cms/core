...
class Criteria extends Struct implements \Stringable
{
    ...
    final public const string STATE_ELASTICSEARCH_AWARE = 'elasticsearchAware';

    final public const string STATE_DISABLE_SEARCH_INFO = 'disableSearchInfo';

    final public const string STATE_SCORE_RANKED_GROUPING = 'scoreRankedGrouping';

    final public const string SCORE_FIELD = '_score';

    /**
     * no total count will be selected. Should be used if no pagination required (fastest)
     */
    final public const int TOTAL_COUNT_MODE_NONE = 0;

    /**
     * exact total count will be selected. Should be used if an exact pagination is required (slow)
     */
    final public const int TOTAL_COUNT_MODE_EXACT = 1;
     ...
     */
    final public const int TOTAL_COUNT_MODE_NEXT_PAGES = 2;

    final public const int ROOT_NESTING_LEVEL = 0;
