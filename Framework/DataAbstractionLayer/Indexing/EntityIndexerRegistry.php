...
{
    final public const string EXTENSION_INDEXER_SKIP = 'indexer-skip';
    final public const string EXTENSION_INDEXER_ONLY = 'indexer-only';

    final public const string USE_INDEXING_QUEUE = 'use-queue-indexing';

    final public const string DISABLE_INDEXING = 'disable-indexing';
     ...
     */
    private function iterateIndexer(string $name, ?array $offset, array $skip, Context $context): ?EntityIndexingMessage
    {
