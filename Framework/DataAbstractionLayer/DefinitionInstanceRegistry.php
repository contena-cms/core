...
use Contena\Core\Framework\DataAbstractionLayer\Dbal\FieldResolver\AbstractFieldResolver;
...
class DefinitionInstanceRegistry
{
    ...
    /**
     * @param array<string, string|class-string<EntityDefinition>> $definitions array of $entityName => $definitionServiceId, e.g. 'product' => '\Contena\Core\Content\Product\ProductDefinition'
