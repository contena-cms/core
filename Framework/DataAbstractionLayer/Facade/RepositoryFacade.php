...
/**
 * The `repository` service allows you to query data, that is stored inside contena.
...
class RepositoryFacade
{
     ...
     *
     * @example repository-search-ids/script.twig Get the IDs of blogs matching the given criteria.
     */
