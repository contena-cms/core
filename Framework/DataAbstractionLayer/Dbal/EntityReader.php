...
class EntityReader implements EntityReaderInterface
{
     ...
     */
    final public const string TO_MANY_ASSOCIATION_LIMIT_QUERY = 'to_many_association_limit_query';
    ...
    private function loadManyToMany(
        ...
        // the ids are extracted in the entity hydrator (see: \Contena\Core\Framework\DataAbstractionLayer\Dbal\EntityHydrator::extractManyToManyIds)
