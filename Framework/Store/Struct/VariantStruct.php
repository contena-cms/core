...
{
    final public const string TYPE_RENT = 'rent';
    final public const string TYPE_BUY = 'buy';
    final public const string TYPE_FREE = 'free';
    final public const int RENT_DURATION_MONTHLY = 1;
    final public const int RENT_DURATION_YEARLY = 12;
