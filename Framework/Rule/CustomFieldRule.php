...
use Contena\Core\Framework\Util\FloatComparator;
...
/**
 * @internal
 * The helper to provide static methods for custom fields rule.
 */
class CustomFieldRule
{
     ...
     */
    public static function match(array $renderedField, array|string|int|bool|float|null $renderedFieldValue, string $operator, array $customFields, ?ChannelContext $context = null): bool
    {
     ...
     */
    public static function getValue(array $customFields, array $renderedField, ?ChannelContext $context = null): array|float|bool|int|string|null
    {
    ...
    public static function getExpectedValue(array|float|bool|int|string|null $renderedFieldValue, array $renderedField): array|float|bool|int|string|null
    {
        ...
        if (self::isSwitchOrBoolField($renderedField)) {
            return $renderedFieldValue ?? false;
        }
