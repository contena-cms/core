...
use Contena\Core\Framework\Plugin\Requirement\Exception\ComposerNameMissingException;
use Contena\Core\Framework\Plugin\Requirement\Exception\ConflictingPackageException;
...
class RequirementsValidator
{
    ...
    private Composer $contenaProjectComposer;
    ...
    public function validateRequirements(PluginEntity $plugin, Context $context, string $method): void
    {
        ...
        $this->contenaProjectComposer = $this->getComposer($this->projectDir);
    ...
    private function checkComposerDependencies(
        ...
        foreach ($packages as $package) {
            // Ignore Contena plugins. They are checked separately in `validateInstalledPlugins`
    ...
    {
        $packages = $this->contenaProjectComposer->getRepositoryManager()->getLocalRepository()->getPackages();
