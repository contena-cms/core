...
class JavascriptPluginGenerator implements ScaffoldingGenerator
{
    ...
    public const string OPTION_NAME = 'create-javascript-plugin';
    private const string OPTION_DESCRIPTION = 'Create an example javascript plugin';
    private const string CLI_QUESTION = 'Do you want to create an example javascript plugin?';
