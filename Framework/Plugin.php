...
abstract class Plugin extends Bundle
{
     ...
     * If needed, return true and Contena will execute `composer require` during the plugin installation.
     * When the plugins gets uninstalled, Contena executes `composer remove`
     */
    ...
    {
        if (str_starts_with(mb_strtolower($this->getMigrationNamespace()), 'contena\core')) {
            throw PluginException::cannotDeleteContenaMigrations();
        }
