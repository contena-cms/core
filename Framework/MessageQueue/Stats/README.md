...
This feature provides statistics about processed messages in the Contena message queue system. It tracks message processing metrics and provides insights into message queue performance.
...
The message queue statistics can be configured in your `config/packages/contena.yaml` file:
