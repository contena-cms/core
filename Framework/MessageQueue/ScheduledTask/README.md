...
The Scheduled Task system provides a robust framework for executing recurring background tasks in Contena. It supports reliable scheduling, execution tracking, error handling, and automatic recovery mechanisms.
...
- **[ScheduleProvider](SymfonyBridge/ScheduleProvider.php)** - Symfony Scheduler integration
