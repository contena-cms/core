...
namespace Contena\Core\Framework\Telemetry;
...
{
    public const string UNKNOWN_LABEL_NAME = 'TELEMETRY__UNKNOWN_METRIC_LABEL';

    public const string INSTRUMENT_WITHOUT_METRIC_OR_SPAN = 'TELEMETRY__INSTRUMENT_WITHOUT_METRIC_OR_SPAN';
