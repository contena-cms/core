...
class CacheController extends AbstractController
{
    ...
    public function info(): JsonResponse
    {
        return new JsonResponse([
            ...
            'httpCache' => $this->container->get('parameter_bag')->has('contena.http.cache.enabled') && $this->getParameter('contena.http.cache.enabled'),
    ...
    public function index(RequestDataBag $dataBag, Context $context): Response
    {
        $data = $dataBag->all();
        ...
        $this->indexerRegistry->sendFullIndexingMessage($skip, $only, $context);
