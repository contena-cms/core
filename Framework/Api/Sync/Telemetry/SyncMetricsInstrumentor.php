...
namespace Contena\Core\Framework\Api\Sync\Telemetry;
...
/**
 * Telemetry collaborator for {@see \Contena\Core\Framework\Api\Sync\SyncService}: derives the Sync API
...
{
    public const string ACTION_UPSERT = 'upsert';
     ...
     */
    private const string INDEXING_BEHAVIOR_DEFAULT = 'default';
