...
namespace Contena\Core\Framework\Webhook\Api;
 ...
 * @codeCoverageIgnore
 *
 * @see \Contena\Tests\Integration\Core\Framework\Webhook\Api\WebhookHealthControllerTest
 */
...
class WebhookHealthController
{
    ...
    public function state(Context $context): JsonResponse
    {
        ...
        return new JsonResponse(['webhooks' => $rows]);
    }
