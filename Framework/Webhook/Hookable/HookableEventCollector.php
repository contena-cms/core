...
use Contena\Core\Framework\DataAbstractionLayer\Attribute\Entity as EntityAttribute;
...
class HookableEventCollector implements ResetInterface
{
    ...
    /**
     * Dynamically discovers all hookable entities by checking for services tagged with 'contena.entity.hookable'.
     *
     * @return list<string>
     */
