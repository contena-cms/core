 ...
 * that does not exist on this Contena version apart from one that exists but is withheld
 ...
 *
 * Implementations are discovered through the `contena.hookable_event.describer` tag.
 *
...
interface HookableEventDescriber
{
     ...
     * version of Contena would permit this manifest to receive.
     *
     * @return list<HookableEventDescription>
     */
