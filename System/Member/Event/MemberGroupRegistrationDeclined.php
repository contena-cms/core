...
class MemberGroupRegistrationDeclined extends Event implements ChannelAware, MemberAware, MailAware, MemberGroupAware, FlowEventAware
{
    final public const EVENT_NAME = 'member.group.registration.declined';
