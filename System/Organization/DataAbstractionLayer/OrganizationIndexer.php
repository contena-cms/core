...
class OrganizationIndexer extends EntityIndexer
{
    ...
    {
        $iterator = $this->iteratorFactory->createIterator($this->organizationRepository->getDefinition(), $context, $offset);
        $ids = $iterator->fetch();
    ...
    {
        return $this->iteratorFactory->createIterator($this->organizationRepository->getDefinition(), $context)->fetchCount();
    }
