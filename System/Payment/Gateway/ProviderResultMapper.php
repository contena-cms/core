...
final class ProviderResultMapper
{
    ...
    public static function paymentResult(array $data, string $status, ?string $method = null): PaymentResult
    {
        ...
        return new PaymentResult(
            ...
            $action,
            $actionValue,
            self::string($data, 'out_trade_no', 'out_request_no', 'out_refund_no', 'out_batch_no', 'out_bill_no', 'out_biz_no', 'external_agreement_no'),
            self::string($data, 'trade_no', 'transaction_id', 'refund_id', 'batch_id', 'order_id', 'transfer_bill_no', 'contract_id', 'agreement_no'),
