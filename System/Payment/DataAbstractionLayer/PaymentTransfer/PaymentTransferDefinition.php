...
class PaymentTransferDefinition extends EntityDefinition
{
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            new OneToManyAssociationField('notifyRecords', PaymentNotifyRecordDefinition::class, 'transfer_id')->addFlags(new ApiAware()),
            new OneToManyAssociationField('channelNotifyRecords', PaymentChannelNotifyRecordDefinition::class, 'transfer_id')->addFlags(new ApiAware()),
        ]);
    }
}
