...
{
    final public const string VIOLATION_PARENT_HAS_PARENT = 'parent_has_parent_violation';

    final public const string VIOLATION_CODE_REQUIRED_FOR_ROOT_LANGUAGE = 'code_required_for_root_language';

    final public const string VIOLATION_DELETE_DEFAULT_LANGUAGE = 'delete_default_language_violation';

    final public const string VIOLATION_DEFAULT_LANGUAGE_PARENT = 'default_language_parent_violation';
