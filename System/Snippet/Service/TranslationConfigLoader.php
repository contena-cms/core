...
class TranslationConfigLoader extends AbstractTranslationConfigLoader
{
    ...
    /**
     * @description Maps the snake_case keys of the `contena.translation` config section to the dash-separated keys used in translation.yaml.
     */
     ...
     *
     * @description `contena.translation` config section - keys left null fall back to translation.yaml
     */
