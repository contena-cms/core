...
class SnippetException extends HttpException
{
    ...
    final public const SNIPPET_LANGUAGE_NOT_AVAILABLE_IN_CHANNEL = 'SYSTEM__SNIPPET_LANGUAGE_NOT_AVAILABLE_IN_CHANNEL';
    ...
    public static function languageNotAvailableInChannel(string $languageId, string $channelId): self
    {
        return new self(
            Response::HTTP_BAD_REQUEST,
            self::SNIPPET_LANGUAGE_NOT_AVAILABLE_IN_CHANNEL,
            'The language "{{ languageId }}" is not available for channel "{{ channelId }}".',
            ['languageId' => $languageId, 'channelId' => $channelId],
        );
    }
