...
namespace Contena\Core\System\Snippet\Command\Util;
...
use Contena\Core\System\Snippet\Struct\TranslationFile;
use Contena\Core\System\Snippet\Struct\TranslationFileCollection;
    ...
    private function getFinder(LintedTranslationFileOptions $options): Finder
    {
        $this->finder
            ...
            ->exclude([
                ...
                'CtLanguagePack/src/Resources/snippet',
                'CtLanguagePack/src/Resources/app/administration/src/snippet',
