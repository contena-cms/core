...
#[AsCommand(
    ...
    For more information, see our documentation: https://developer.contena.cn/docs/concepts/translations/fallback-language-selection.html#migration-and-linting-via-command',
)]
class LintTranslationFilesCommand extends Command
{
    ...
    private function renderOutput(
        ...
        https://developer.contena.cn/docs/concepts/translations/fallback-language-selection.html
        CLI);
