 ...
 * @internal
 *
 * @phpstan-type CustomFieldTypeArray array{name?: string, type?: string, config: array{label: array<string, string>, helpText: array<string, string>, customFieldPosition: int, validation?: 'required'}, includeInSearch?: true}
 */
abstract class CustomFieldType extends XmlElement
{
    protected const array TRANSLATABLE_FIELDS = [
        'label',
        'help-text',
    ];
