...
use Contena\Core\Framework\Util\XmlParserUtils;
 ...
 * @internal
 *
 * @phpstan-type CustomFieldSetArray array{id?: string, name?: string, global: bool, config: array<string, mixed>, relations: array<array<string, string>>, extensionName?: string, customFields: list<array<string, mixed>>}
 */
class CustomFieldSet extends XmlElement
{
    ...
    private const array TRANSLATABLE_FIELDS = ['label'];
     ...
     */
    public function toEntityArray(array &$existingRelations, array &$existingFields, ?string $existingSetId = null): array
    {
