 ...
 * @internal
 */
#[McpTool(name: self::NAME, title: 'Tool Search', description: 'Search the Channel API MCP tool catalogue by free-text query and return the most relevant tool definitions inline. Use this when a needed tool is not visible in tools/list.')]
#[McpToolGroup('discovery')]
class ChannelApiToolSearchTool extends AbstractToolSearchTool
{
    /**
