...
class ChannelApiCustomFieldMapper implements ResetInterface
{
    /**
     * @internal
     *
...
WHERE custom_field.channel_api_aware = 1
');
    ...
    private function decodeValue(string $type, mixed $value): mixed
    {
        return match ($type) {
            ...
            CustomFieldTypes::SELECT, CustomFieldTypes::JSON => $this->decodeArrayValues($value),
