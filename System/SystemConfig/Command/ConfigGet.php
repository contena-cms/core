...
namespace Contena\Core\System\SystemConfig\Command;
...
class ConfigGet extends Command
{
    ...
    private const string FORMAT_SCALAR = 'scalar';
    private const string FORMAT_JSON = 'json';
    private const string FORMAT_JSON_PRETTY = 'json-pretty';

    private const array ALLOWED_FORMATS = [
        self::FORMAT_DEFAULT,
        self::FORMAT_SCALAR,
        self::FORMAT_JSON,
    ...
    protected function configure(): void
    {
        $this
            ...
            ->addOption('channelId', 'c', InputOption::VALUE_OPTIONAL)
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $value = $this->systemConfigService->get($configKey, $input->getOption('channelId'), Context::createCLIContext());
