...
class Kernel extends HttpKernel
{
     ...
     */
    final public const string CONTENA_FALLBACK_VERSION = '6.8.9999999-dev';

    protected static ?Connection $connection = null;

    protected string $contenaVersion;

    protected ?string $contenaVersionRevision;
    ...
    public function __construct(
        ...
        $versionArray = VersionParser::parseContenaVersion($version);
        $this->contenaVersion = $versionArray['version'];
        $this->contenaVersionRevision = $versionArray['revision'];
    ...
    protected function getKernelParameters(): array
    {
        ...
        return array_merge(
            ...
            [
                ...
                'kernel.contena_core_dir' => $coreDir,
    ...
    protected function getCacheHash(): string
    {
        ...
        return Hasher::hash([
            $this->cacheId,
            (string) $this->contenaVersionRevision,
            $plugins,
        ]);
    }
...
PHP;
     ...
     */
    private function isBundleRegistered(Bundle|ContenaBundle $bundle, array $instantiatedBundleNames): bool
    {
