...
class StaticEntityRepository extends EntityRepository
{
     ...
     *
     * @param class-string<TCollection> $collectionClass Used only to bind the generic collection type.
    ...
    public function search(Criteria $criteria, Context $context): EntitySearchResult
    {
        ...
        if ($result instanceof EntityCollection) {
            ...
            return new EntitySearchResult($result->count(), $result, null, $criteria, $context);
        }
        ...
        if ($result instanceof AggregationResultCollection) {
            ...
            return new EntitySearchResult(0, $collection, $result, $criteria, $context);
        }
