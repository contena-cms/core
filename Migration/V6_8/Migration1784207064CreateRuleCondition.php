    ...
    public function update(Connection $connection): void
    {
        $connection->executeStatement(<<<'SQL'
            CREATE TABLE IF NOT EXISTS `rule_condition` (
                ...
                PRIMARY KEY (`id`),
                INDEX `idx.rule_condition.data_scope_id` (`data_scope_id`),
                ...
                CONSTRAINT `fk.rule_condition.data_scope_id` FOREIGN KEY (`data_scope_id`) REFERENCES `data_scope` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
