...
CREATE TABLE IF NOT EXISTS `payment_recurring` (
    ...
    `status` TINYINT NOT NULL DEFAULT 0 COMMENT 'Status: 0=pending, 1=signed, 2=unsigned',
...
CREATE TABLE IF NOT EXISTS `payment_channel_notify_record` (
    ...
    `notify_type` TINYINT NOT NULL COMMENT 'Notification type: 1=payment, 2=refund, 3=close',
    ...
    `status` TINYINT NOT NULL DEFAULT 0 COMMENT 'Status: 0=pending, 1=processed, 2=ignored',
